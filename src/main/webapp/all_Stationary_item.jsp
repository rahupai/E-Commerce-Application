...
<title>All Stationary Items</title>
...
<body>
	...
	<div class="container-fluid">
		<div class="row p-3">
			...
			List<ItemDtls> list = dao.getAllStationaryItem();
				...
				<div class="card crd-ho mt-2">
					<div class="card-body text-center">
						...
						<div class="row ">
							...
							<a href="view_items.jsp?iid=<%=it.getItemId()%>" class="btn btn-success btn-sm ml-1">View Details</a> 
